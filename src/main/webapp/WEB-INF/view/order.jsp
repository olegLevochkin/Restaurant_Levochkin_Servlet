...
<h3><fmt:message key="order.notEnought">Ukrainian</fmt:message></h3>
</c:if>
...
<table class="table">
    <tr>
        ...
        <th scope="col">
            <fmt:message key="dish.delete">dele</fmt:message>
        </th>
    </tr>
        ...
        <tr>
            ...
            <td>
                <form action="${pageContext.request.contextPath}/app/order/removeD" method="post">
                    <button class="btn btn-danger" name="dish" style="margin-top:10px;" type="submit"
...
<form action="${pageContext.request.contextPath}/app/order/addedOrder" method="post">
    <c:if test="${notEnought == null}">
        <button class="btn btn-success enter" name="actA" type="submit" value="Registrate">
